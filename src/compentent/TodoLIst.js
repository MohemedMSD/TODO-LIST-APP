        ...
        <div className='tasks row col-10 mt-4 mx-auto'>
            {
                ...
                tasks && tasks.map((task, key) =>
                    <div key={key} data-key={task.id} className='div_task col-12 col-md-6 col-lg-4 col-xl-3 '>
                        <div  className={task.complete ? 'task rounded completed d-flex justify-content-between p-2 mt-3' : 'task rounded d-flex justify-content-between p-2 mt-3'}>
                            ...
                            <div className='icons col-4 p-0 d-flex align-items-center justify-content-around'>
                                <FiEdit className='icon' size={20} onClick={()=> EditTask(task.id)}/>
                                <AiTwotoneDelete className='icon' size={24} onClick={(e)=> funcdelet(e, task.id)}/>
                            </div>
                        </div>
                    </div>
                )
